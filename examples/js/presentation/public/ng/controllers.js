...
.controller('AppCtrl', ['$scope', '$http', '$location', '$window', '$route', '$rootScope', '$log', function($scope, $http, $location, $window, $route, $rootScope, $log) {
    ...
    return function(min, max) {
	   ...
	   var result = "";
	   for(i = 0; i < words; i++) {
            var newTxt = bank[Math.floor(Math.random() * (bank.length - 1))];
